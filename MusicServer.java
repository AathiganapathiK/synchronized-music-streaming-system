...
public class MusicServer {
    ...
    /** Broadcast a command + arguments to all connected clients **/
    ...
    /** Send updated song list (names without .mp3) **/
    ...
    static class ClientHandler implements Runnable {
        ...
        /** NEW: receive file as a single byte[] */
        ...
        /** Helper to send a command + zero or more args **/
